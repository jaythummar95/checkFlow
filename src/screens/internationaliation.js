  ...
  const renderLanguageList = () => (
    <View style={styles.languageListContainer}>
      <Text
        ...
        style={[
          styles.languageSelectionCell,
          selectedLanguage == 'en' && styles.languageSelectionCellSelected,
        ]}>
        {'English'}
      </Text>
      <Text
        ...
        style={[
          styles.languageSelectionCell,
          selectedLanguage == 'ar' && styles.languageSelectionCellSelected,
        ]}>
        {'Arabic'}
      </Text>
    </View>
  ...
  const renderListOfFruits = () => (
    <View>
      {listOfFruits.map((item, index) => (
        <Text key={index} style={styles.styleFruitListItem}>
          {item}
        </Text>
      ))}
    </View>
